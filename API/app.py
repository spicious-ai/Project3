...
def fires():
  # Create our session (link) from Python to the DB
    ...
    results = engine.execute('select FIRE_NAME, FIRE_YEAR, LATITUDE, CONT_DATE, DISCOVERY_DATE, LONGITUDE, FIRE_SIZE, NWCG_GENERAL_CAUSE from fires where FIRE_SIZE > 3000').all()
